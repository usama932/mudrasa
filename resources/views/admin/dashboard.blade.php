                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Dashboard/ ڈیش بورڈ</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>Welcome to Muhammdia Dar ul Quran./محمدیہ دارالقرآن میں خوش آمدید۔</p>
                                            </div>
                                                        ...
                                                        <div class="card-inner">
                                                            <div class="card-title-group align-start mb-2">
                                                                ...
                                                                <div class="card-tools">
                                                                    <em class="card-hint icon ni ni-help-fill" data-toggle="tooltip" data-placement="left" title="Students Enrolement"></em>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="card-inner pb-0">
                                                                ...
                                                                <div class="data">
                                                                    <div class="data-group">
                                                                        ...
                                                                        <div class="info text-right"><span class="change up text-danger"><em class="icon ni ni-arrow-long-up"></em>7.13%</span><br><span>vs. last week</span></div>
                                                                    </div>
                                                                </div>
                                                            </div><!-- .card-inner -->
                                                            <div class="nk-ecwg3-ck">
                                                ...
                                                <div class="card-inner">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <ul class="flex-shrink-0 gy-2">
                                                            ...
                                                            <li class="align-center">
                                                                <span class="dot dot-lg sq mr-1" data-bg="#9cabff"></span>
                                                                <span> Mobile Application</span>
                                                            </li>
                                                            <li class="align-center">
                                                                <span class="dot dot-lg sq mr-1" data-bg="#8feac5"></span>
                                                                <span> Graphics Design</span>
                                                            </li>
                                                            <li class="align-center">
                                                                <span class="dot dot-lg sq mr-1" data-bg="#6b79c8"></span>
                                                                <span> Database</span>
                                                            </li>
                                                            <li class="align-center">
                                                                <span class="dot dot-lg sq mr-1" data-bg="#79f1dc"></span>
                                                                <span> Marketing</span>
                                                            </li>
                                                            <li class="align-center">
                                                                <span class="dot dot-lg sq mr-1" data-bg="#FF65B6"></span>
                                                                <span> Machine Learning</span>
                                                            </li>
                                                            <li class="align-center">
                                                                <span class="dot dot-lg sq mr-1" data-bg="#6A29FF"></span>
